...
def parse():
    ...
    parser.add_argument('-l', '--data-path-intermediate', type=Path, default='/root/fastMRI/model/test_varnet_with_attn_Unet/intermediate_varnet_leaderboard/reconstructions_val')
...
if __name__ == '__main__':
    args = parse()
    args.exp_dir = '/root/fastMRI/model' / args.net_name / 'checkpoints'
    args.forward_dir = '/root/fastMRI/model' / args.net_name / 'reconstructions_forward'
