import argparse
import shutil
from utils.learning.train_part_unet_attn_ckp import train
...
def parse():
    ...
    parser.add_argument('-l', '--lr', type=float, default=0.000001, help='Learning rate')
    ...
    parser.add_argument('--out-chans', type=int, default=2, help='Size of output channels for network')
