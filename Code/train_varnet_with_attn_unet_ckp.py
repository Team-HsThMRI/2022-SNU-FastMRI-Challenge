import argparse
import shutil
from unet.utils.learning.train_part_varnet_with_attn_unet_ckp import train
...
def parse():
    ...
    parser.add_argument('-l', '--lr', type=float, default=5 * 1e-6, help='Learning rate')
    ...
    parser.add_argument('-v', '--data-path-val', type=Path, default='/root/fastMRI/unet/result/test_varnet_with_attn_Unet/intermediate_varnet_val/reconstructions_val/',
...
if __name__ == '__main__':
    ...
    args.val_dir_1 = '../result' / args.net_name / 'intermediate_varnet/reconstructions_val'
    args.val_dir_2 = '../result' / args.net_name / 'reconstructions_val'
