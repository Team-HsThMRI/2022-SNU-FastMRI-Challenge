import argparse
import shutil
from utils.learning.train_part_unet import train
...
def parse():
    ...
    parser.add_argument('-t', '--data-path-train', type=Path,
                        default='/content/drive/Shareddrives/2022 FastMRI/train/image/', help='Directory of train data')
    parser.add_argument('-v', '--data-path-val', type=Path,
                        default='/content/drive/Shareddrives/2022 FastMRI/val/image/',
