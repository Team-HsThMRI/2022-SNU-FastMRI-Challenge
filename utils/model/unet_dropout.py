...
class Unet(nn.Module):
    ...
    def __init__(self, in_chans, out_chans):
        ...
        self.down1 = Down(64, 128, 0.25)
        self.down2 = Down(128, 256, 0.5)
        self.down3 = Down(256, 512, 0.5)
        self.down4 = Down(512, 1024, 0.5)
        self.down5 = Down(1024, 2048, 0.5)
        self.up1 = Up(2048, 1024, 0.5)
        self.up2 = Up(1024, 512, 0.5)
        self.up3 = Up(512, 256, 0.5)
        self.up4 = Up(256, 128, 0.5)
        self.up5 = Up(128, 64, 0.0)
